...
<header class="container">
    ...
    <div class="about element backgroundClip">
        <h class="url" data-redirect="/b">
            About
            <div class="underlined"></div>
        </h>
    </div>
    <div class="skills element backgroundClip">
        <h class="url" data-redirect="/c">
            Skills
            <div class="underlined"></div>
        </h>
    </div>
    <div class="links element backgroundClip">
        <h class="url" data-redirect="/d">
            Links
            <div class="underlined"></div>
        </h>
    </div>
...
<style>
    ...
    .container {
        ...
        gap: 0px 0px; 
        grid-template-areas: 
            "logo space projects about skills links";
    }
    .element {
        height: 100%; 
        text-align: center;
    ...
    .element:hover .underlined {
        transition: width .5s cubic-bezier(0.53, 0.15, 0, 1.1);
        width: 100%;
    }
    .active {
        color: var(--dark-text);
